        ...
        <footer className="content-footer footer bg-footer-theme">
            <div className="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
              ...
              <div className="d-none d-lg-inline-block">
                ...
                <a aria-label="go to themeselection web" href="https://themeselection.com/" target="_blank" rel='noreferrer' className="footer-link me-4">More Themes</a>

                <a aria-label="go to themeselection" href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/documentation/"
                  target="_blank" rel='noreferrer' className="footer-link me-4">Documentation</a>

                <a aria-label="go to themeselection issue" href="https://github.com/themeselection/sneat-html-admin-template-free/issues" target="_blank" rel='noreferrer'
